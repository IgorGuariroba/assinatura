                        ...
                        <div class="card card--col" :id="item.ref" id="Pro">
                            <div class="card__header">
                                ...
                                <div class="card__price"><span class="price-currency mr-2"
                                                               x-text="item.price.currency">R$</span> <span
                                        class="price-value"
                                        x-text="item.price[currentPricing]">{{$plan->price_br}}</span> <span
                                        class="price-period"><span class="px-1">/</span><span
                                            x-text="translate()">{{$plan->enum_label}}</span></span></div>
                            </div>
                            <div class="card__features">
                                <template x-for="(feature, index) in item.features"
                                          :key="index">
                                    <p class="feature">
                                ...
                                <p class="feature">
                                    ...
                                    <span x-text="feature">{{$feature->name}}</span></p>
                                @endforeach
                            </div>
                            <div class="card__footer text-center my-4"><a href="{{route('choice.plan',$plan->url)}}"
                                                                          class="button button--filled button--primary">Assinar
                                    Agora Mesmo
                                    <svg
