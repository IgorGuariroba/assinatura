                        ...
                        <div class="card card--col" :id="item.ref" id="Pro">
                            <div class="card__header">
                                <div class="flex items-center justify-between">
                                    ...
                                    <template><span class="badge"></span></template>
                                    @if($plan->recomended)
                                        <span class="badge">Recomendado</span>
                                    @endif
                                </div>
                                <div class="card__price"><span class="price-currency mr-2">R$</span> <span
                                        class="price-value">{{$plan->price_br}}</span> <span
                                        class="price-period"><span class="px-1">/</span><span>{{$plan->enum_label}}</span></span></div>
                            </div>
