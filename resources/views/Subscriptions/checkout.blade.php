                    ...
                    <form action="{{route('subscription.store')}}" method="post" id="form">
                        ...
                        <div class="col-span-6 sm:col-span-4 py-2">
                            <input type="text" name="card-holder-name" id="card-holder-name"
                                   placeholder="nome" class="w-full
                                   px-3 py-2 placeholder-gray-300 border
                        ...
                        <div class="col-span-6 sm:col-span-4 py-2">
                            <button type="submit"
                                    ...
                                    id="card-bottom"
                                    class="inline-flex justify-center py-2 px-4 border shadow-sm text-sm font-medium rounded-md bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Enviar
                            </button>
                        </div>
                    </form>
...
<script>
    ...
    const clientSecret = cardBottom.dataset.secret;
