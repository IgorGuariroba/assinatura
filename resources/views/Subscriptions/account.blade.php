                        ...
                        @foreach ($invoices as $invoice)
                            <tr>
                                ...
                                <td class="px-6 py-4 border-b text-sm">
                                    <a href="{{ route('subscription.invoice.download', $invoice->id) }}" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">
                                        Baixar
                                    </a>
                                </td>
                            </tr>
